...
function Testimonial() {
  return (
    <div className="testibody">
      ...
      ></img>
      <div className="testicard"></div>
      <img
        className="testibigbuttons"
        src="https://firebasestorage.googleapis.com/v0/b/portfolio-39221.appspot.com/o/Portfolio-Images%2Fjaga.png?alt=media&token=be6e0390-171e-49cc-9cfa-659e8134ab61"
      ></img>
      ...
      ></img>
      <div className="testicomenttator">FOUNDER AND CEO OF KARMANI</div>
      <div className="testiimage"></div>
    </div>
  );
}
